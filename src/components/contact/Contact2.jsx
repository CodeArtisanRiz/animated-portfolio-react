...
const Contact2 = () => {
  ...
  return (
    <div className="xl:mt-12 xl:flex-row flex-col-reverse flex gap-6 overflow-hidden">
      <motion.div
        variants={slideIn('left', 'tween', 0.2, 1)}
        className="flex-[0.75] bg-black-100 p-8 rounded-2xl cform "
        >
          ...
          <form 
            ...
            id="contactForm" 
            name="sentMessage"
            className="mt-12 flex flex-col gap-3 fm">
